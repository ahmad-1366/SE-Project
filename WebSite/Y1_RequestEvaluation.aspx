<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Y1_RequestEvaluation.aspx.cs" Inherits="Y1_RequestEvaluation" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="sidebar-panel">
            <ul>
                <li><a href="Y1_RequestEvaluation.aspx">Evaluate Requests</a></li>
                <li><a href="Y2_ViewNotifications.aspx">View Notifications</a></li>
                <li><a href="DefaultLogin.aspx">Logout</a></li>
            </ul>
        </div>
        <div class="maincontent-panel">
            <div class="m-subheader">
                <h3 class="usertype-header">FYP Department</h3>
                    ...
                    <div class="student-summary">
                        ...
                        <div class="operationsheader">
                            ...
                            <div class="operationselect">
                                <asp:Button ID="ObjectRequest" runat="server" Text="Raise Objection" Width="170px"
                ...
                <div>
                    <asp:GridView ID="RequestsList" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Evaluation" HeaderText="Evaluation" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="30%"/>
